    ...
    <nav className="navbar navbar-expand-lg navbar-light _header_nav _padd_t10">
      <div className="container _custom_container">
        <div className="_logo_wrap">
          <RouterLink className="navbar-brand" to="/feed">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <BasicInput 
                ...
                sx={{
                  '& .MuiOutlinedInput-root': {
                    height: '40px', // Header inputs are usually smaller
                    paddingLeft: '35px', // Space for SVG icon
                  },
                  '& .MuiInputBase-input': {
          ...
          <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
            <li className="nav-item _header_nav_item">
              <RouterLink className="nav-link _header_nav_link_active _header_nav_link" aria-current="page" to="/feed">
            ...
            <li className="nav-item _header_nav_item">
              <RouterLink className="nav-link _header_nav_link" to="/friend-request">
            ...
            <li className="nav-item _header_nav_item">
              <RouterLink className="nav-link _header_nav_link" to="/chat">
          ...
          <div className="_header_nav_profile" onClick={() => setShowProfileDrop(!showProfileDrop)} style={{ cursor: 'pointer', position: 'relative' }}>
            <div className="_header_nav_profile_image">
              <UserAvatar src={user?.avatar} className="_nav_profile_img" />
            </div>
            ...
            <div id="_profile_drop" className={`_nav_profile_dropdown _profile_dropdown ${showProfileDrop ? '_show' : ''}`} style={{ display: showProfileDrop ? 'block' : 'none' }} onClick={(e) => e.stopPropagation()}>
              <div className="_nav_profile_dropdown_info">
                <div className="_nav_profile_dropdown_image">
                  <UserAvatar src={user?.avatar} className="_nav_drop_img" />
                </div>
                <div className="_nav_profile_dropdown_info_txt">
                  <h4 className="_nav_dropdown_title">{user?.name || 'User'}</h4>
                  <RouterLink to="/profile" className="_nav_drop_profile" onClick={() => setShowProfileDrop(false)}>View Profile</RouterLink>
                </div>
              </div>
              <hr />
